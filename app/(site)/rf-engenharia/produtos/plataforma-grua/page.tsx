            ...
            <div className="w-full lg:w-[40%]">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-primary-medium/10">
                ...
                <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
                  <Image
                    src="/images/equipment/plataforma-grua.jpg"
                    alt="Plataforma de grua para movimentação em obra"
                    fill
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {advantages.map((adv) => (
                <div key={adv.title} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 border border-gray-100">
                  <IconCircleCheck className="w-5 h-5 text-primary-medium shrink-0" />
                  <span className="text-sm text-text-primary font-medium">{adv.title}</span>
                </div>
              ))}
            </div>
          </div>
